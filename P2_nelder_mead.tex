...
\begin{document}
    ...
    \begin{multicols}{2}
        ...
        \begin{itemize}
            ...
            \item El diámetro del símplex $\mathcal{S}$ se define como \[diam(\mathcal{S}) = \max_{1 \leq i,~j \leq n+1} \lVert x_i - x_j\rVert\]
        ...
        \section{Paso a paso del algoritmo}
            ...
            Se ordenan los vértices del símplex de menor a mayor valor de la función.
            
            \subsection*{PASO 2. Reflejar}
            
            \begin{enumerate}
                \item Se calcula el \textit{centroide}: \[\hat{x}=\frac{1}{n}\sum_{i=1}^{n} x_i\]
            ...
            Si $f_r \geq f_n$ se realiza una \textit{contracción}:
